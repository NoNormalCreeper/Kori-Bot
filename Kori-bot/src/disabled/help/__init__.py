...
from nonebot.typing import T_State; from nonebot.params import State
from nonebot.adapters.onebot.v11 import Adapter, Event, GroupMessageEvent
...
async def get_help_msg(group_id='', plugin_name=''):
    # plugin_name = str(event.getasync def _(bot: Bot, event: Event, state: T_State = State()):_message()).strip()
